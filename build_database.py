...
budapest_df = budapest_df.loc[budapest_df["dateOfSale"] > date_dict['BUDA_date_max']]
...
for drink in master_drinks:
    ...
    df = df[['idDrink', 'strDrink', 'strCategory', 'strIBA', 'strAlcoholic', 'strGlass', 'dateModified']]
    # append data
    dfs.append(df)
...
global_df.to_sql('global_sales', conn, if_exists='append', index=True, index_label='saleID')
bar_stock_df.to_sql('bar_stock', conn, if_exists='append', index=True, index_label='stockID')
